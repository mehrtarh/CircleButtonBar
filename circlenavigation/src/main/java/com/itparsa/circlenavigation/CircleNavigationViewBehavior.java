 ...
 */
class CircleNavigationViewBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    public CircleNavigationViewBehavior(Context context, AttributeSet attrs) {
        super();
    }

    public CircleNavigationViewBehavior() {
        super();
    }
